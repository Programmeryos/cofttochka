    ...
    <section className="relative min-h-[80vh] h-auto flex items-center overflow-hidden bg-brand-light py-16 md:py-0">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          <h1
            className="text-4xl sm:text-5xl md:text-7xl font-serif font-bold leading-tight mb-4 md:mb-6 animate-slide-up"
          >
            В&apos;язаний одяг, <br />
          ...
          <p
            className="text-base md:text-xl text-neutral-600 mb-6 md:mb-10 max-w-lg leading-relaxed animate-slide-up [animation-delay:0.2s]"
          >

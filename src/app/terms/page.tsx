...
export const metadata: Metadata = {
  title: 'Умови використання | COFTOCHKA.UA',
  description: 'Умови та правила використання інтернет-магазину COFTOCHKA.UA. Порядок замовлення, оплати, доставки та повернення товарів.',
  alternates: {
    canonical: 'https://coftochka.ua/terms',
  },
};
            ...
            <div className="prose prose-neutral max-w-none space-y-12">
              <section>
                ...
                <div className="space-y-4 text-neutral-700 leading-relaxed">
                  <p>1.1. Цей документ є офіційною публічною офертою фізичної особи — підприємця, що здійснює діяльність під торговою маркою <strong>COFTOCHKA.UA</strong> (далі — «Продавець», «Ми»), та містить умови договору купівлі-продажу товарів дистанційним способом.</p>
                  <p>1.2. Особа, що здійснює замовлення на Сайті <strong>https://coftochka.ua</strong> (далі — «Покупець», «Ви»), вважається такою, що прийняла (акцептувала) цю оферту в повному обсязі з моменту підтвердження замовлення.</p>
              ...
              <section>
                ...
                <div className="space-y-4 text-neutral-700 leading-relaxed">
                  ...
                  <p>5.3. <strong>Безкоштовна доставка</strong> надається при вартості замовлення від <strong>1 500 гривень</strong>.</p>
                  <p>5.4. Покупець зобов&apos;язаний перевірити цілісність пакування та відповідність Товару при отриманні.</p>
                </div>
              </section>

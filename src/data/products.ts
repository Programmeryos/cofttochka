...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: "Об'ємна кофта насиченого теракотового кольору. Створена для тих, хто цінує стиль, комфорт та натуральні матеріали.",
  ...
  },
  {
    ...
    description: "Елегантна приталена кофта, що ідеально підкреслює фігуру. Чудово поєднується як з класичними брюками, так і з повсякденними джинсами.",
